...
<div class="container mx-auto flex justify-center items-center min-h-screen bg-gradient-to-br from-amber-100 to-orange-200">
    <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-lg transform transition-all hover:shadow-xl">
        ...
        <!-- Message de succès -->
        @if(session('success'))
            <div class="mb-6 p-3 bg-green-100 text-green-700 rounded-lg flex items-center">
        ...
        <p class="mt-4 text-center text-gray-600">
            Pas de compte ? 
            <a href="{{ route('register') }}" class="text-amber-600 hover:text-amber-800 font-medium transition-colors">
                Inscrivez-vous
            </a>
        </p>
    </div>
